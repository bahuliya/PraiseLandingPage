...
export const ProductTeaserCard = (props: ProductTeaserCardProps) => {
  const {
    dailyVolume = "",
    dailyVolumeLabel = "FREE BETA ACCESS",
    headline = "Spend Less Time on Data. More Time on Valuation.",
    ...
    description = "",
    videoSrc = "",
    posterSrc = "https://images.unsplash.com/photo-1448630360428-65456885c650?w=800&h=800&fit=crop",
