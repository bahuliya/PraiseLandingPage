        ...
        <div className="grid grid-cols-12 gap-5 gap-y-16">
          <div className="col-span-12 md:col-span-6 relative z-10">
            ...
            >
              ...
              >
                instead of focusing on high-value analysis and expertise.
              </span>
            </h2>
            ...
            >
              Hours spent pulling data from multiple sources, manual entry and cleanup in comp grids, and fragmented data across counties and systems—Praise changes that.
            </p>
